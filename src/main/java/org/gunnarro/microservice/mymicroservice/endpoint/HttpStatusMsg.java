...
public class HttpStatusMsg {
    ...
    public static final String HTTP_204_CODE = "204";
    ...
    public static final String HTTP_401_CODE = "401";
    public static final String HTTP_401_MSG = "You are not authorized to view the resource";

    public static final String HTTP_403_CODE = "403";
    ...
    public static final String HTTP_410_CODE = "410";
    public static final String HTTP_410_MSG = "Gone";

    public static final String HTTP_429_CODE = "429";
    ...
    public static final String HTTP_503_CODE = "503";
